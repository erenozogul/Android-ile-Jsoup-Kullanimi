...
import com.example.veriekme.gida.EtUrunleriFragment;
...
public class EvGerecleriFragment extends Fragment {

    private ArrayList<ItemClass> itemClassArrayList = new ArrayList<>();
    private ListView listView;
    private ItemAdapter itemAdapter;
    private static String URL="https://www.cimri.com/mutfak-gerecleri";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ev_ev_gerecleri, container, false);
