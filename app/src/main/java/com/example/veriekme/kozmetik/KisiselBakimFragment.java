...
import com.example.veriekme.giyim.ayakkabiFragment;
...
public class KisiselBakimFragment extends Fragment {

    private ArrayList<ItemClass> itemClassArrayList = new ArrayList<>();
    private ListView listView;
    private ItemAdapter itemAdapter;
    private static String URL="https://www.cimri.com/kisisel-bakim-gerecleri";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.kozmetik_kisisel_bakim, container, false);
    ...
    private class VeriGetir extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setTitle("Kozmetik Kategorisi");
