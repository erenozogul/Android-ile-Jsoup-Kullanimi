...
import com.example.veriekme.giyim.cocukFragment;
...
public class ParfumKozmetikFragment extends Fragment {
    ...
    private static String URL="https://www.cimri.com/makyaj-urunleri";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.kozmetik_parfum_kozmetik, container, false);
