...
public class SaglikUrunleriFragment extends Fragment {
    ...
    private static String URL="https://www.cimri.com/saglik-diyet";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.kozmetik_saglik_urunleri, container, false);
