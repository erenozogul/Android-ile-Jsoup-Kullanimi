...
public class SporGiyimFragment extends Fragment {
    ...
    private static String URL="https://www.cimri.com/spor-giyim";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.spor_spor_giyim, container, false);
